...
const Jobs = () => {
  return (
    <div class="bg-white pt-12 pr-0 pb-12 pl-0 mt-0 mr-auto mb-0 ml-auto sm:py-16 lg:py-20" id="jobs">
      ...
      <div class="pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto max-w-4xl sm:px-6 lg:px-8">
        <div class="pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto sm:flex sm:items-center sm:justify-between">
          ...
          <h2 className='font-medium'>
            ...
            <p class="text-sm mt-1 mr-0 mb-0 ml-0 font-semi-bold text-gray-500">Apply to remote jobs around the world.</p>
          </div>
