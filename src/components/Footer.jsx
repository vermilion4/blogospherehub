...
const Footer = () => {
  return (
    <footer class="bg-gradient-to-r from-emerald-600 to-emerald-600 text-white">
  <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <div className='middle font-bold'>
          <span className='border-2 border-white bg-emerald-600 text-white uppercase text-xl p-2'>
            Blogosphere
          </span>
          Hub<span className='text-emerald-600'>.</span>
        </div>
        <p class="max-w-xs mt-4 text-sm text-gray-100">
        Did you come here for something in particular or just general Perusal
        </p>
      ...
      <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-3">
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-100">
            <a class="hover:opacity-75 cursor-pointer" href> Travel </a>
            <a class="hover:opacity-75 cursor-pointer" href> Technology </a>
            <a class="hover:opacity-75 cursor-pointer" href> Lifestyle </a>
            <a class="hover:opacity-75 cursor-pointer" href> Fashion </a>
          </nav>
        </div>
        <div>
          <p class="font-medium">
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-100">
            <a class="hover:opacity-75 cursor-pointer" href> News </a>
            <a class="hover:opacity-75 cursor-pointer" href> Upcoming Events </a>
            <a class="hover:opacity-75 cursor-pointer" href> Job Board </a>
          </nav>
        </div>
        <div>
          <p class="font-medium">
